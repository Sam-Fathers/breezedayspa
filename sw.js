  ...
  e.waitUntil(
    caches.open(SHELL)
      .then(cache => Promise.all(
        // Cache each file on its own. addAll() rejects the entire install if a
        // single file 404s, which silently disables offline support.
...
// Lets the page force a waiting worker to take over after a content update.
